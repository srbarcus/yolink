 ...
 *  2.0.2: Added unit values to: temperature, battery
...
preferences {
    input title: bold("Driver Version"), description: "Smoke & CO Alarm (YS7A01-UC) v${clientVersion()}${copyright()}", displayDuringSetup: false, type: "paragraph", element: "paragraph"	
