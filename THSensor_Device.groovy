...
def parseDevice(object, source) {
    ...
    switch(source) {
		case "devicestate":         
            ...
            period = object.data.state.alarm.period
            code = object.data.state.alarm.code         
        ...
        case "report":                 
            ...
            period = object.data.alarm.period
            code = object.data.alarm.code         
    ...
    rememberState("period",period)
    rememberState("code",code)
    ...
    //temperature = Double.valueOf(temperature) + Double.valueOf(parent.convertTemperature(state.tempCorrection))
    ...
    // Override Alarms reported by API    
