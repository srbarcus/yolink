 ...
 *  2.1.29: Add Device Model information to 'Device Info" Data section.
 */
...
private def get_APP_VERSION() {return "2.1.29"}
...
private create_yolink_device(Hubitat_dni,devname,devtype,devtoken,devId,devModel) {
    ...
    logDebug("Calling child device setup: $newdni, $state.homeID, $labelName, $devtype, $devtoken, $devId")
    dev.ServiceSetup(newdni,state.homeID,labelName,devtype,devtoken,devId) 	                // Initial setup of the Child Device

    dev.updateDataValue("deviceModel", devModel.toString()) // Update Device Model in "Device Info" section
